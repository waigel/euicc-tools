...
"    card)\n"
"      if (( CURRENT == 3 )); then\n"
"        _values 'card subcommand' info profiles notifications install enable disable delete\n"
"      else\n"
"        _arguments -s \\\n"
...
"      COMPREPLY=($(compgen -W \"info profiles notifications install enable disable delete\" -- \"$cur\"))\n"
"    else\n"
...
usage(void) {
    fputs(
        ...
        "       euicc card info|profiles|notifications|install|enable|disable|\n"
        "            delete [options]\n"
        "\n"
        "  build    value notation in, DER out\n"
        "  show     DER in, value notation out\n"
